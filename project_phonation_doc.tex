...
Approximations will be made, particularly where they allow analysis to continue while avoiding the intense complications that come with completeness. %the complications of including advanced mechanics, which itself is a consequence of analysis. 
...
i.e. $\frac{d}{dt}\left(P(b)\right) = f(b)\frac{db}{dt} $ %some of this might be abusive. consider in terms of d/db
...
% consideration of why this occurs. potential wells

% rigorous understanding of the range of oscillations


% behaviour of oscillations local to the "matrix points"
