...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{quadplot_phaseplane_versus_time}
    \caption{
...
See Figure \ref{fig:phaseportrait_compare}
...
We will study a range of behaviours exhibited by the model when oscillating
