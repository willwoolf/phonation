...
We will study a range of behaviours exhibited by the model when oscillating first by proposing the parameters $\mu=1,~q=0.2$.
This satisfies Equation \ref{eqn:osc_condition}. Refer to subfigures A and B of Figure \ref{fig:phaseportrait_compare},
where we have plotted some of these curves.
Observe the plot in figure A which starts near the critical point.
It appears that in this case, the plate remains stationary for a period of time before oscillations begin,
