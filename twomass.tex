...
\begin{figure}
    ...
    \caption{
        Computation of behavours starting at equilibrium solutions.
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{figures/twomass_timeseries_settling.eps}
    \caption{
...
\begin{figure}
    ...
    \caption{
        ...
        since the computer cannot ``know'' the analytical solution.
