...
We assume the masses to move one-dimensionally, perpendicular to the principal direction of the flow such that they may extend indefinitely.
We assume a plug flow, as discussed in the introduction. % citation here - there's a text "fundamentals of fluid mechanics 9780471675822"
...
A volume $V_j$ has dimensions $h_j \mathrm{wd}$, where $h_j + b_j = \mathrm{h}$ for $j=1,2$.
...
%TODO: The chunk above is about the flux relationships. rework virtually all of it, since the quasisteady flow neglects a lot of the analysis
